...
5. **SDK Demo Fix**
   - Corrected baseUrl in `/app/sdk/page.tsx` from "https://www.swaps.pro/api/sdk/v1" to "https://www.swaps.pro"
   - Fixed 404 error on SDK quote request
...
- Fixed SDK issue with minimal change (corrected baseUrl)
