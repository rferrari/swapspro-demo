            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
                <label className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="mt-2 sm:mt-0 sm:flex-sm:flex-row sm:items-center">
                    <button
                      onClick={() => setTheme('dark')}
                      className={`px-3 py-1 rounded border ${
                        theme === 'dark' ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-gray-800 text-gray-300 border-gray-700'
                      }`}
                    >
                      Dark
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 rounded border ml-2 ${
                        theme === 'light' ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-gray-800 text-gray-300 border-gray-700'
                      }`}
                    >
                      Light
                    </button>
